...
final class AitsysManagementRenderController extends PhabricatorController {
  ...
  public function handleRequest(AphrontRequest $request) {
    ...
    $classes = id(new PhutilClassMapQuery())
      ->setAncestorClass('AitsysManagement')
    ...
    require_celerity_resource('aitsys-management-css');
