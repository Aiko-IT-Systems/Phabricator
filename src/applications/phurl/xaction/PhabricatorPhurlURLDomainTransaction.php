...
final class PhabricatorPhurlURLDomainTransaction
  extends PhabricatorPhurlURLTransactionType {

  const TRANSACTIONTYPE = 'phurl.domain';
  ...
  public function getTitle() {
    return pht(
      '%s changed the domain from %s to %s.',
      $this->renderAuthor(),
      $this->renderOldValue(),
      $this->renderNewValue());
  }
  ...
  public function getTitleForFeed() {
    return pht(
      '%s changed the domain of %s from %s to %s.',
      $this->renderAuthor(),
      $this->renderObject(),
      $this->renderOldValue(),
      $this->renderNewValue());
